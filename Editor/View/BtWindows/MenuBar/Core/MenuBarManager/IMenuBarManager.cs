...
namespace Editor.View.BtWindows.MenuBar.Core.MenuBarManager
{
    ...
    public interface IMenuBarManager
    {
        ...
        /// <summary>
        /// Adds an icon item to the menu bar and registers its associated events.
        /// </summary>
        /// <param name="icon">The icon item to add to the menu bar.</param>
        void AddIconItem(IMenuBarIcon icon);

        /// <summary>
        /// Removes an icon item from the menu bar and unregisters its associated events.
        /// </summary>
        /// <param name="icon">The icon item to remove from the menu bar.</param>
        /// <returns>True if the icon item was successfully removed; otherwise, false.</returns>
        bool RemoveIconItem(IMenuBarIcon icon);

        /// <summary>
        /// Event triggered when an icon item in the menu bar is clicked.
        /// </summary>
        /// <remarks>
        /// This event is fired whenever a specific icon item in the menu bar is clicked by the user.
        /// Subscribers to this event can use it to handle interactions with the clicked icon,
        /// such as executing commands, displaying a tooltip, or updating the UI based on the action.
        /// </remarks>
        /// <event>
        /// The event passes the clicked icon item of type <see cref="IMenuBarIcon"/>
        /// as a parameter, enabling listeners to process or interact with the clicked icon item.
        /// </event>
        event Action<IMenuBarIcon> OnIconClicked;
